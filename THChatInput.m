...
- (void) composeView
{
	...
	self.textView = [[UITextView alloc] initWithFrame:CGRectMake(70.0f, topGap, 185, topGap)];
...
//	textView.font = [UIFont systemFontOfSize:15.0f];
    [textView setFont:[UIFont fontWithName:@"AvenirNextLTPro-Regular" size:17.0]];
//    AvenirNextLTPro-Regular
   ...
   [self adjustTextInputHeightForText:@"" animated:NO];
	...
	self.attachButton = [UIButton buttonWithType:UIButtonTypeContactAdd];
   ...
   [self sendSubviewToBack:inputBackgroundView];
    ...
    else
    {
        ...
        [sendButton.titleLabel setFont:[UIFont fontWithName:@"AvenirNextLTPro-Regular" size:14]];
...
//    sendButton.frame = CGRectMake(sendButton.frame.origin.x,topGap,sendButton.frame.size.width,sendButton.frame.size.height);
    sendButton.frame = CGRectMake(sendButton.frame.origin.x,
                                  self.frame.size.height/2 - sendButton.frame.size.height/2,
